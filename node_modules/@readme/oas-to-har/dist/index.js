import {
  configureSecurity
} from "./chunk-EOITCV6F.js";

// src/index.ts
import { parse as parseDataUrl } from "@readme/data-urls";
import lodashGet2 from "lodash.get";
      ...
      if (opts.parentIsArray) {
        ...
        if (parentData !== void 0 && Array.isArray(parentData)) {
          return Object.keys(parentData).map((pdk) => {
            ...
            if (lodashGet(opts.payload, currentKey) !== void 0) {
              return currentKey;
            }
            return false;
          }).filter(Boolean);
        }
      } else if (opts.parentKey && lodashGet(opts.payload, opts.parentKey) !== void 0) {
              ...
              if (Array.isArray(jsonTypes) && jsonTypes.length) {
                try {
                  jsonTypes.forEach((prop) => {
                    try {
                      lodashSet(cleanBody, prop, JSON.parse(lodashGet2(cleanBody, prop)));
                    } catch (e) {
                    }
                  });
