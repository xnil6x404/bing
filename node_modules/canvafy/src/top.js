...
module.exports = class Top {
  constructor(options) {
      this.font = { name: (options && options.font && options.font.name) ? options.font.name : "Poppins", path: (options && options.font && options.font.path) ? options.font.path : null };
      this.usersData = options && options.usersData || [{ top: 1, avatar: "https://i.pinimg.com/736x/c6/a8/5f/c6a85f7dbcbf367d5dc1baa2aaa19a73.jpg", tag: "Beş#0005", score: 5 },{ top: 2, avatar: "https://i.pinimg.com/736x/c6/a8/5f/c6a85f7dbcbf367d5dc1baa2aaa19a73.jpg", tag: "Beş#0005", score: 5 },{ top: 3, avatar: "https://i.pinimg.com/736x/c6/a8/5f/c6a85f7dbcbf367d5dc1baa2aaa19a73.jpg", tag: "Beş#0005", score: 5 }];
      this.background = {
        type: "none",
        background: "none"
      };
      ...
      this.opacity = 0;
      this.scoreMessage = "";
      this.colors = options && options.colors || { box: '#212121', username: '#ffffff', score: '#ffffff', firstRank: '#f7c716', secondRank: '#9e9e9e', thirdRank: '#94610f' };
  }
