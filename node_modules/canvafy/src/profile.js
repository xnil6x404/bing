...
module.exports = class Profile {
  constructor(options) {
      this.font = { 
          name: (options && options.font && options.font.name) ? options.font.name : "Poppins", 
          path: (options && options.font && options.font.path) ? options.font.path : './assets/fonts/Poppins/Poppins-Regular.ttf' 
      };
  ...
  setBorder(color) {
    ...
    async build() {
        ...
        if (data && data.bannerURL !== null)
 {
          let banner = `${data && data.bannerURL ? data.bannerURL : ''}?size=512`;
