...
class Rank {
    ...
    async build(ops = { fontX: "Manrope", fontY: "Manrope" }) {
        ...
        // draw username
      ctx.font = `bold ${this.data.fontSize !== undefined ? this.data.fontSize : "36px"} ${ops.fontX}`;
        ...
        if (discrim) {
          ctx.font = `bold ${this.data.fontSize !== undefined ? this.data.fontSize : "36px"} ${ops.fontY}`;
