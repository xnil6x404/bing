import { O as Operation } from './index-57c67780.js';
 ...
 *
 */
declare function getExtension(extension: string | keyof Extensions, api: OASDocument, operation?: Operation): unknown;
/**
...
export { CODE_SAMPLES, EXPLORER_ENABLED, Extensions, HEADERS, METRICS_ENABLED, PARAMETER_ORDERING, PROXY_ENABLED, SAMPLES_LANGUAGES, SIMPLE_MODE, extensionDefaults, getExtension, hasRootExtension, validateParameterOrdering };
