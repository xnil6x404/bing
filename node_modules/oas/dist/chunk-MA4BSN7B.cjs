...
var _chunkHFPHOHB4cjs = require('./chunk-HFPHOHB4.cjs');
...
var _chunkGMRP5T42cjs = require('./chunk-GMRP5T42.cjs');

// src/index.ts
var _jsonschemarefparser = require('@readme/json-schema-ref-parser'); var _jsonschemarefparser2 = _interopRequireDefault(_jsonschemarefparser);
...
var Oas = class _Oas {
  ...
  operation(path, method, opts = {}) {
    ...
    if (opts.isWebhook) {
      ...
      if (_optionalChain([api, 'optionalAccess', _7 => _7.webhooks, 'access', _8 => _8[path], 'optionalAccess', _9 => _9[method]])) {
        ...
        return new (0, _chunkHFPHOHB4cjs.Webhook)(api, path, method, operation);
      }
    }
    ...
    return new (0, _chunkHFPHOHB4cjs.Operation)(this.api, path, method, operation);
  }
  ...
  hasExtension(extension) {
    return _chunkGMRP5T42cjs.hasRootExtension.call(void 0, extension, this.api);
  }
  /**
  ...
  getExtension(extension, operation) {
    return _chunkGMRP5T42cjs.getExtension.call(void 0, extension, this.api, operation);
  }
  /**
  ...
  validateExtension(extension) {
    if (this.hasExtension("x-readme")) {
      ...
      if (extension in data) {
        if ([_chunkGMRP5T42cjs.CODE_SAMPLES, _chunkGMRP5T42cjs.HEADERS, _chunkGMRP5T42cjs.PARAMETER_ORDERING, _chunkGMRP5T42cjs.SAMPLES_LANGUAGES].includes(extension)) {
          if (!Array.isArray(data[extension])) {
            throw new TypeError(`"x-readme.${extension}" must be of type "Array"`);
          }
          if (extension === _chunkGMRP5T42cjs.PARAMETER_ORDERING) {
            _chunkGMRP5T42cjs.validateParameterOrdering.call(void 0, data[extension], `x-readme.${extension}`);
          }
    ...
    if (this.hasExtension(`x-${extension}`)) {
      ...
      if ([_chunkGMRP5T42cjs.CODE_SAMPLES, _chunkGMRP5T42cjs.HEADERS, _chunkGMRP5T42cjs.PARAMETER_ORDERING, _chunkGMRP5T42cjs.SAMPLES_LANGUAGES].includes(extension)) {
        ...
        if (extension === _chunkGMRP5T42cjs.PARAMETER_ORDERING) {
          _chunkGMRP5T42cjs.validateParameterOrdering.call(void 0, data, `x-${extension}`);
        }
   ...
   */
  validateExtensions() {
    Object.keys(_chunkGMRP5T42cjs.extensionDefaults).forEach((extension) => {
  ...
  async dereference(opts = { preserveRefAsJSONSchemaTitle: false }) {
    ...
    if (api && api.components && api.components.schemas && typeof api.components.schemas === "object") {
      Object.keys(api.components.schemas).forEach((schemaName) => {
        if (_chunkDYR74CLDcjs.isPrimitive.call(void 0, api.components.schemas[schemaName]) || Array.isArray(api.components.schemas[schemaName]) || api.components.schemas[schemaName] === null) {
          return;
        }
...
exports.Oas = Oas;
//# sourceMappingURL=chunk-MA4BSN7B.cjs.map