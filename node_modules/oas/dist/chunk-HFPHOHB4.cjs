...
var _chunkVIIXOUMHcjs = require('./chunk-VIIXOUMH.cjs');
...
var _chunkDYR74CLDcjs = require('./chunk-DYR74CLD.cjs');


var _chunk4MZ45ISUcjs = require('./chunk-4MZ45ISU.cjs');
...
function dedupeCommonParameters(parameters, commonParameters) {
  return commonParameters.filter((param) => {
    return !parameters.find((param2) => {
      ...
      } else if (_chunk4MZ45ISUcjs.isRef.call(void 0, param) && _chunk4MZ45ISUcjs.isRef.call(void 0, param2)) {
...
function objectify(thing) {
  if (!_chunkDYR74CLDcjs.isObject.call(void 0, thing)) {
    return {};
  }
  return thing;
}
...
var samples_default = _memoizee2.default.call(void 0, sampleFromSchema);
...
function getMediaTypeExamples(mediaType, mediaTypeObject, opts = {}) {
  ...
  if (mediaTypeObject.schema) {
    if (!_chunkDYR74CLDcjs.matches_mimetype_default.xml(mediaType)) {
      return [
        {
...
function getResponseExamples(operation) {
  return Object.keys(operation.responses || {}).map((status) => {
    ...
    if (_chunk4MZ45ISUcjs.isRef.call(void 0, response)) {
      return false;
    }
    const mediaTypes = {};
...
var isJSON = _chunkDYR74CLDcjs.matches_mimetype_default.json;
function buildHeadersSchema(response, opts) {
  ...
  Object.keys(headers).forEach((key) => {
    if (headers[key] && headers[key].schema) {
      ...
      headersSchema.properties[key] = _chunkDYR74CLDcjs.toJSONSchema.call(void 0, header.schema, {
...
function getResponseAsJSONSchema(operation, api, statusCode, opts) {
  ...
  function getPreferredSchema(content) {
    ...
    for (let i = 0; i < contentTypes.length; i++) {
      if (isJSON(contentTypes[i])) {
        return _chunkDYR74CLDcjs.toJSONSchema.call(void 0, _chunkDYR74CLDcjs.cloneObject.call(void 0, content[contentTypes[i]].schema), {
          addEnumsToDescriptions: true,
          refLogger,
          transformer: opts.transformer
        });
    ...
    return _chunkDYR74CLDcjs.toJSONSchema.call(void 0, _chunkDYR74CLDcjs.cloneObject.call(void 0, content[contentType].schema), {
      addEnumsToDescriptions: true,
      refLogger,
      transformer: opts.transformer
    });
  ...
  if (foundSchema) {
    const schema = _chunkDYR74CLDcjs.cloneObject.call(void 0, foundSchema);
    const schemaWrapper = {
      ...
      schema: _chunkDYR74CLDcjs.isPrimitive.call(void 0, schema) ? schema : {
        ...schema,
        $schema: _chunkDYR74CLDcjs.getSchemaVersionString.call(void 0, schema, api)
      },
      label: "Response body"
    };
...
var Operation = class {
  ...
  getSummary() {
    if (_optionalChain([this, 'access', _2 => _2.schema, 'optionalAccess', _3 => _3.summary]) && typeof this.schema.summary === "string") {
  ...
  getDescription() {
    if (_optionalChain([this, 'access', _4 => _4.schema, 'optionalAccess', _5 => _5.description]) && typeof this.schema.description === "string") {
  ...
  getContentType() {
    ...
    if (this.schema.requestBody) {
      if ("$ref" in this.schema.requestBody) {
        this.schema.requestBody = _chunkVIIXOUMHcjs.findSchemaDefinition.call(void 0, this.schema.requestBody.$ref, this.api);
      }
    ...
    types.forEach((t) => {
      if (_chunkDYR74CLDcjs.matches_mimetype_default.json(t)) {
        this.contentType = t;
      }
    });
    return this.contentType;
  ...
  isFormUrlEncoded() {
    return _chunkDYR74CLDcjs.matches_mimetype_default.formUrlEncoded(this.getContentType());
  }
  isMultipart() {
    return _chunkDYR74CLDcjs.matches_mimetype_default.multipart(this.getContentType());
  }
  isJson() {
    return _chunkDYR74CLDcjs.matches_mimetype_default.json(this.getContentType());
  }
  isXml() {
    return _chunkDYR74CLDcjs.matches_mimetype_default.xml(this.getContentType());
  }
  /**
   ...
   */
  getSecurity() {
    if (!_optionalChain([this, 'access', _6 => _6.api, 'optionalAccess', _7 => _7.components, 'optionalAccess', _8 => _8.securitySchemes]) || !Object.keys(this.api.components.securitySchemes).length) {
      return [];
    }
  ...
  getOperationId(opts) {
    function sanitize(id) {
      return id.replace(_optionalChain([opts, 'optionalAccess', _9 => _9.camelCase]) ? /[^a-zA-Z0-9_]/g : /[^a-zA-Z0-9]/g, "-").replace(/--+/g, "-").replace(/^-|-$/g, "");
    }
    let operationId;
    ...
    if (_optionalChain([opts, 'optionalAccess', _10 => _10.camelCase])) {
   ...
   */
  getParameters() {
    let parameters = _optionalChain([this, 'access', _11 => _11.schema, 'optionalAccess', _12 => _12.parameters]) || [];
    const commonParams = _optionalChain([this, 'access', _13 => _13.api, 'optionalAccess', _14 => _14.paths, 'optionalAccess', _15 => _15[this.path], 'optionalAccess', _16 => _16.parameters]) || [];
  ...
  getParametersAsJSONSchema(opts = {}) {
    return _chunkDYR74CLDcjs.getParametersAsJSONSchema.call(void 0, this, this.api, {
  ...
  getRequestBodyMediaTypes() {
    ...
    if (_chunk4MZ45ISUcjs.isRef.call(void 0, requestBody)) {
      return [];
    }
  ...
  getRequestBody(mediaType) {
    ...
    mediaTypes.forEach((mt) => {
      if (!availableMediaType && _chunkDYR74CLDcjs.matches_mimetype_default.json(mt)) {
  ...
  getCallbacks() {
    ...
    Object.keys(this.schema.callbacks).forEach((callback) => {
      Object.keys(this.schema.callbacks[callback]).forEach((expression) => {
        ...
        if (!_chunk4MZ45ISUcjs.isRef.call(void 0, cb)) {
          const exp = cb[expression];
          if (!_chunk4MZ45ISUcjs.isRef.call(void 0, exp)) {
  ...
  getExtension(extension) {
    return _optionalChain([this, 'access', _17 => _17.schema, 'optionalAccess', _18 => _18[extension]]);
  }
};
var Callback = class extends Operation {
  ...
  getSummary() {
    if (_optionalChain([this, 'access', _19 => _19.schema, 'optionalAccess', _20 => _20.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
  ...
  getDescription() {
    if (_optionalChain([this, 'access', _21 => _21.schema, 'optionalAccess', _22 => _22.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
  ...
  getParameters() {
    let parameters = _optionalChain([this, 'access', _23 => _23.schema, 'optionalAccess', _24 => _24.parameters]) || [];
...
var Webhook = class extends Operation {
  getSummary() {
    if (_optionalChain([this, 'access', _25 => _25.schema, 'optionalAccess', _26 => _26.summary]) && typeof this.schema.summary === "string") {
      return this.schema.summary;
  ...
  getDescription() {
    if (_optionalChain([this, 'access', _27 => _27.schema, 'optionalAccess', _28 => _28.description]) && typeof this.schema.description === "string") {
      return this.schema.description;
 ...
 */
//# sourceMappingURL=chunk-HFPHOHB4.cjs.map